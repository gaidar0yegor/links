...
async def show_campaign_summary(query_or_message: CallbackQuery | Message, state: FSMContext, campaign_id: int):
    ...
    # Format sales rank display with descriptive ranges (must match create.py values!)
    max_rank = params.get('max_sales_rank', 10000)
    rank_descriptions = {
        500: "🏆 Ранг 1 (1-500): Элитные топ товары",
        1000: "🥈 Ранг 2 (501-1000): Очень популярные",
        3000: "🥉 Ранг 3 (1001-3000): Популярные",
        5000: "⭐ Ранг 4 (3001-5000): Хорошие",
        10000: "📈 Ранг 5 (5001-10000): Расширенный выбор",
        100000: "🔍 Ранг 6 (10000+): Для непопулярных категорий"
    }
